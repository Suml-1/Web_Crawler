...
# 单线程
# def main(home_url):
#     href = get_novel_id(url = home_url)
...
#         print(book_name, chapter_urllist)
...
#     url = "https://www.xiakexsw.com/type/2_0_0_0_0_1.html"
#     main(home_url = url)
...
if __name__ == '__main__':
    url = "https://www.xiakexsw.com/type/1_0_1_1_0_1.html"
    href = get_novel_id(url = url)
    exe = concurrent.futures.ThreadPoolExecutor(max_workers=2)
    for novel_id in href:
        exe.submit(main, novel_id = novel_id)
        time.sleep(1)
    exe.shutdown()
